...
public final class WebCrawlerTest {
  ...
  public void zeroMaxDepth(Class<?> crawlerClass) throws Exception {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  public void noStartPages(Class<?> crawlerClass) throws Exception {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  public void testBasicCrawl(Class<?> crawlerClass) throws Exception {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  public void respectsIgnoredUrls(Class<?> crawlerClass) throws Exception {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  public void respectsIgnoredWords(Class<?> crawlerClass) throws Exception {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  public void respectsMaxDepth(Class<?> crawlerClass) throws Exception {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(1)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  public void pageNotFoundStillCountsAsVisited(Class<?> crawlerClass) throws Exception {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  public void infiniteLoop(Class<?> crawlerClass) throws Exception {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
  ...
  @ParameterizedTest
  @MethodSource("provideTestParameters")
  public void multipleStartingUrls(Class<?> crawlerClass) throws Exception {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(crawlerClass.getName())
            .setMaxDepth(10)
